...
public class Deck {
    ...
    Deck() {
        ...
        cards[25] = new Card("Four of Wands", "Community, Home, Celebration");
        cards[26] = new Card("Five of Wands", "Competition, Conflict, Reality");
        cards[27] = new Card("Six of Wands", "Victory, Success, Public Reward");
        cards[28] = new Card("Seven of Wands", "Perserverance, Mounting A Defence, Maintaining Control");
        cards[29] = new Card("Eight of Wands", "Rapid Action, Monument, Quick Decisions");
        cards[30] = new Card("Nine of Wands", "Resilience, Grit, Taking Last Stand");
        cards[31] = new Card("Ten of Wands", "Accomplishment, Responsibility, Burden");
        cards[32] = new Card("Page of Wands", "Exploration, Excitement, Freedom");
        cards[33] = new Card("Knight of Wands", "Action, Adventure, Fearlessness");
        ...
        cards[39] = new Card("Four of Cups", "Apathy, Contemplation, Disconnection");
        cards[40] = new Card("Five of Cups", "Loss, Grief, Disappointment, Mourning");
        cards[41] = new Card("Six of Cups", "Familiarity, Memories, Healing, Restoration");
        cards[42] = new Card("Seven of Cups", "Searching for Purporse, Choices, Daydreaming");
        cards[43] = new Card("Eight of Cups", "Walking Away, Disillusionment, Leaving Something Behind");
        cards[44] = new Card("Nine of Cups", "Satisfaction, Luxury, Emotional Stability");
        cards[45] = new Card("Ten of Cups", "Inner Happiness, Fulfillment, Dreams Coming True");
        cards[46] = new Card("Page of Cups", "Happy Surprise, Dreamer, Sensitiviry");
        cards[47] = new Card("Knight of Cups", "Idealistic, Romantic, Following One's Heart");
        ...
        cards[53] = new Card("Four of Swords", "Rest, Restoration, Contemplation");
        cards[54] = new Card("Five of Swords", "Unbridled Ambition, Win At All Costs, Sneakiness");
        cards[55] = new Card("Six of Swords", "Transition, Leaving Behind, Moving On");
        cards[56] = new Card("Seven of Swords", "Deception, Trickery, Tactics and Strategy");
        cards[57] = new Card("Eight of Swords", "Imprisonment, Entrapment, Self-Victimization");
        cards[58] = new Card("Nine of Swords", "Anxiety, Hopelessness, Trauma");
        cards[59] = new Card("Ten of Swords", "Failure, Collapse, Defeat, Backstabbing");
        cards[60] = new Card("Page of Swords", "Curiosity, Restlessness, Mental Energy");
        cards[61] = new Card("Knight of Swords", "Action, Impulsiveness, Defending Beliefs");
        ...
        cards[67] = new Card("Four of Pentacles", "Conservation, Security, Frugality");
        cards[68] = new Card("Five of Pentacles", "Need, Poverty, Insecurity, Low Resources");
        cards[69] = new Card("Six of Pentacles", "Charity, Generosity, Sharing");
        cards[70] = new Card("Seven of Pentacles", "Hard Work, Perserverance, Diligence");
        cards[71] = new Card("Eight of Pentacles", "Diligence, Passion, High Standards");
        cards[72] = new Card("Nine of Pentacles", "Fruits of Labour, Reckless Spending, Rewards");
        cards[73] = new Card("Ten of Pentacles", "Legacy, Inheritance, Culmination");
        cards[74] = new Card("Page of Pentacles", "Ambition, Desire, Diligence, Craving New Venture");
